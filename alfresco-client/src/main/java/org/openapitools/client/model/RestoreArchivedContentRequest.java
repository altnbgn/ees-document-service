...
public class RestoreArchivedContentRequest {
  public static final String SERIALIZED_NAME_RESTORE_PRIORITY = "restorePriority";
  @SerializedName(SERIALIZED_NAME_RESTORE_PRIORITY)
  ...
  **/
  ...
  @ApiModelProperty(value = "Restore from archive priority (Standard/High - to be mapped to Storage Provider specific values in Cloud Connectors)")
