...
public class ActivitiesApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 400 </td><td> Invalid parameter: value of **maxItems**, **skipCount**, or **who** is invalid  </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Authentication failed </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Current user does not have access to the activities for **personId** </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> **personId** or **siteId** does not exist  </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Unexpected error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call listActivitiesForPersonCall(String personId, Integer skipCount, Integer maxItems, String who, String siteId, List<String> fields, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listActivitiesForPersonValidateBeforeCall(String personId, Integer skipCount, Integer maxItems, String who, String siteId, List<String> fields, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listActivitiesForPersonCall(personId, skipCount, maxItems, who, siteId, fields, _callback);
        return localVarCall;
    ...
    public ActivityPaging listActivitiesForPerson(String personId, Integer skipCount, Integer maxItems, String who, String siteId, List<String> fields) throws ApiException {
        ApiResponse<ActivityPaging> localVarResp = listActivitiesForPersonWithHttpInfo(personId, skipCount, maxItems, who, siteId, fields);
    ...
    public ApiResponse<ActivityPaging> listActivitiesForPersonWithHttpInfo(String personId, Integer skipCount, Integer maxItems, String who, String siteId, List<String> fields) throws ApiException {
        okhttp3.Call localVarCall = listActivitiesForPersonValidateBeforeCall(personId, skipCount, maxItems, who, siteId, fields, null);
     ...
     */
    public okhttp3.Call listActivitiesForPersonAsync(String personId, Integer skipCount, Integer maxItems, String who, String siteId, List<String> fields, final ApiCallback<ActivityPaging> _callback) throws ApiException {

        okhttp3.Call localVarCall = listActivitiesForPersonValidateBeforeCall(personId, skipCount, maxItems, who, siteId, fields, _callback);
        Type localVarReturnType = new TypeToken<ActivityPaging>(){}.getType();
