...
public class ActionsApiTest {
     ...
     */
    @Test
    public void actionDetailsTest() throws ApiException {
     ...
     */
    @Test
    public void actionExecTest() throws ApiException {
        ActionBodyExec actionBodyExec = null;
        ActionExecResultEntry response = api.actionExec(actionBodyExec);
     ...
     */
    @Test
    public void nodeActionsTest() throws ApiException {
        String nodeId = null;
        Integer skipCount = null;
        Integer maxItems = null;
        List<String> orderBy = null;
